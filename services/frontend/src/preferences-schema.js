...
export const WORKSPACE_SETTINGS = [
  ...
  { key: 'sideCollapsed', group: 'Layout', label: 'Collapse sidebar', description: 'Give the conversation more space on desktop. Use the sidebar icon to expand it again.', type: 'boolean', value: false },
